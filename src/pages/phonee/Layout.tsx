...
import {
  LayoutDashboard, Building2, Users, Receipt, DollarSign, TrendingUp, Inbox, LogOut, UserPlus, Target, Ticket, Gift, Handshake, ShieldAlert, ShieldCheck,
} from "lucide-react";
...
const nav = [
  ...
  { to: "/phonee/indicacoes",  label: "Indicações",   icon: Gift },
